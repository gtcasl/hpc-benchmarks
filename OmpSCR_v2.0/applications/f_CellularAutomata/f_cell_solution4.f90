...
!
!			We synchronized only the first two copy operations
!		
!			A parallel region inside a loop, 1 explicit barrier
!			to protect the data copies across threads
!			Second barrier is implicit in the parallel-region end
!
!COMMENTS:
...
!
!USAGE: 	./f_cell.solution4 <size_x> <size_y> <numiter>
!
...
! 3.2. END PARALLEL REGION (BARRIER IMPLICIT)
!$OMP	END PARALLEL
