...
c
c ... balance the load among processes
      do ip = 1, num_procs
...
c
c ... try a simple block packing scheme
      n1 = 1
      n2 = num_procs
...
c ... if can't find a good solution, fall back to next method
...
c
      goto 300
c
c ... use a bin-packing scheme to balance the load among processes
  110 continue
      do iz = 1, num_zones
         zone_proc_id(iz) = -1
      end do
