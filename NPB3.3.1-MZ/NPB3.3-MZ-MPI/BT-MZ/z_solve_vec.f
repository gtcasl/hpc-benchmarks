...
c---------------------------------------------------------------------
     ...
     >              - tmp1 * dz5
               ...
               lhs(1,1,bb,i,k) = 1.d0
     >              + tmp1 * 2.d0 * njac(1,1,i,k)
     >              + tmp1 * 2.d0 * dz1
               lhs(1,2,bb,i,k) = tmp1 * 2.d0 * njac(1,2,i,k)
               lhs(1,3,bb,i,k) = tmp1 * 2.d0 * njac(1,3,i,k)
               lhs(1,4,bb,i,k) = tmp1 * 2.d0 * njac(1,4,i,k)
               lhs(1,5,bb,i,k) = tmp1 * 2.d0 * njac(1,5,i,k)

               lhs(2,1,bb,i,k) = tmp1 * 2.d0 * njac(2,1,i,k)
               lhs(2,2,bb,i,k) = 1.d0
     >              + tmp1 * 2.d0 * njac(2,2,i,k)
     >              + tmp1 * 2.d0 * dz2
               lhs(2,3,bb,i,k) = tmp1 * 2.d0 * njac(2,3,i,k)
               lhs(2,4,bb,i,k) = tmp1 * 2.d0 * njac(2,4,i,k)
               lhs(2,5,bb,i,k) = tmp1 * 2.d0 * njac(2,5,i,k)

               lhs(3,1,bb,i,k) = tmp1 * 2.d0 * njac(3,1,i,k)
               lhs(3,2,bb,i,k) = tmp1 * 2.d0 * njac(3,2,i,k)
               lhs(3,3,bb,i,k) = 1.d0
     >              + tmp1 * 2.d0 * njac(3,3,i,k)
     >              + tmp1 * 2.d0 * dz3
               lhs(3,4,bb,i,k) = tmp1 * 2.d0 * njac(3,4,i,k)
               lhs(3,5,bb,i,k) = tmp1 * 2.d0 * njac(3,5,i,k)

               lhs(4,1,bb,i,k) = tmp1 * 2.d0 * njac(4,1,i,k)
               lhs(4,2,bb,i,k) = tmp1 * 2.d0 * njac(4,2,i,k)
               lhs(4,3,bb,i,k) = tmp1 * 2.d0 * njac(4,3,i,k)
               lhs(4,4,bb,i,k) = 1.d0
     >              + tmp1 * 2.d0 * njac(4,4,i,k)
     >              + tmp1 * 2.d0 * dz4
               lhs(4,5,bb,i,k) = tmp1 * 2.d0 * njac(4,5,i,k)

               lhs(5,1,bb,i,k) = tmp1 * 2.d0 * njac(5,1,i,k)
               lhs(5,2,bb,i,k) = tmp1 * 2.d0 * njac(5,2,i,k)
               lhs(5,3,bb,i,k) = tmp1 * 2.d0 * njac(5,3,i,k)
               lhs(5,4,bb,i,k) = tmp1 * 2.d0 * njac(5,4,i,k)
               lhs(5,5,bb,i,k) = 1.d0
     >              + tmp1 * 2.d0 * njac(5,5,i,k) 
     >              + tmp1 * 2.d0 * dz5
